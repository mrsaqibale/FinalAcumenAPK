...
class _SoloChatsWidgetState extends State<SoloChatsWidget>
  ...
  Future<void> _createNewChat(Map<String, dynamic> student) async {
    ...
    if (currentUser == null || student['id'] == currentUser.uid) return;
    ...
    return Column(
      children: [
        TabBar(
          ...
          tabs: const [Tab(text: 'RECENT CHATS'), Tab(text: 'ALL STUDENTS')],
        ...
        Expanded(
          child: TabBarView(
            controller: _tabController,
            children: [_buildRecentChats(), _buildAllStudents()],
          ),
        ),
      ],
    );
        ...
        return ListTile(
          ...
          subtitle: Text(
            student['rollNumber'] != null &&
                    student['rollNumber'].toString().isNotEmpty
